      ...
      <?php
          ...
          try
          {
              if( isset($_POST["matricula"]) ) {
                  $result = $db->query("SELECT * FROM aluno WHERE matricula='{$_POST["matricula"]}'");
              ...
              if( !isset($_SESSION["ehAluno"]) ) {
                  echo "
                  <h2 class='dosis-bold' style='text-align: center;'>TERMO DE COMPROMISSO</h2><br>
                  <div class='body-paragraph'>
                    <p>Prezado(a) participante:</p>
                    <p>Meu nome é Fabrícia Damando Santos e estou realizando Doutorado no Programa de Pós-graduação em Informática na Educação (PPGIE), na Universidade Federal do Rio Grande do sul (UFRGS) sob Orientação da Professora Dra. Magda Bercht, atuando na linha de pesquisa “Paradigmas para a Pesquisa sobre o Ensino Científico e Tecnológico”,juntamente com o Grupo de Pesquisa em Computação Afetiva Aplicada a Educação (GCAE).</p>
                    <p>A presente pesquisa também faz parte de um projeto aprovado pela SEAD, onde se  busca investigar como  reconhecer  o estado de ânimo dos alunos em ambientes virtuais de ensino e aprendizagem (AVEA), pois pode afetar a forma como desenvolverás teus estudos,  tornando importante o seu estudo e formas de identificação.</p>
                    <p>Nesta etapa da pesquisa, precisamos coletar dados das suas interações no Moodle para a disciplina ECO03010 – Análise de demonstrações contábeis e, aplicaremos um questionário para apoio na identificação desta dimensão afetiva no AVEA Moodle. O questionário, apoiado com um mapa chamado de GEW (Geneva Emotion Wheel) e liderado por Klaus Scherer, será aplicado com o intuito em obter um auto-relato dos afetos sentidos por você em determinadas situações de aprendizagem.</p>
                    <p>A participação nesse trabalho é voluntária e em nenhum momento seu nome será citado nos resultados apresentados.</p>
                    <p>Gostaríamos de solicitar o seu auxílio na pesquisa respondendo ao questionário que segue.</p><br>
                    <p class='text-right'>Agradecemos a colaboração.</p>
                    <p class='text-right'>Profa. Dra. Magda Bercht – Coordenadora GCAE</p>
                    <p class='text-right'>Profa. MSc. Fabrícia Damando Santos – Pesquisadora</p><br><br>
